   ...
   //Structure to hold the details of a persons
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        */
        ...
        // ** Start code here. 2 lines approximately. **/
        require(tokenDetails[msg.sender].remainingTokens >= _count, "Remaining tokens must greater than or equals bidded tokens");
        require(tokenDetails[msg.sender].remainingTokens > 0, "Not enough tokens");
        require(_itemId <= 2, "Item id must less than or equals 2");
        //** End code here. **
    ...
    function revealWinners() public onlyOwner{
        ...
        for (uint id = 0; id < 3; id++) {
            ...
            Person storage winner = bidders[winnerId];
            winners[id] = winner.addr;
            //** end code here*
